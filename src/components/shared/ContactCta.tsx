                ...
                <div className={"framer-1acrwa0"} data-framer-name={"Contact Form"} style={{ backgroundColor: "var(--token-5cace45c-5aeb-4596-8405-46748e8b644b, rgb(255, 255, 255))", willChange: "transform", borderBottomLeftRadius: "20px", borderBottomRightRadius: "20px", borderTopLeftRadius: "20px", borderTopRightRadius: "20px", opacity: "0", transform: "translateY(40px)" } as React.CSSProperties}>
                  ...
                  <SiteForm className="framer-10k5ome" action={contactCta.form.action}>
                    ...
                    <label className={"framer-1irorkc"}>
                      <input className={"framer-form-boolean-input framer-1b708wg"} required={true} type={"checkbox"} name={"Newsletter"} style={{ '--framer-input-background': "rgba(186, 186, 186, 0)", '--framer-input-boolean-checked-background': "var(--token-1c49fc01-5a06-4e84-9621-823d64297d7d, rgb(17, 17, 17))", '--framer-input-border-bottom-width': "1px", '--framer-input-border-color': "var(--token-1c49fc01-5a06-4e84-9621-823d64297d7d, rgb(17, 17, 17))", '--framer-input-border-left-width': "1px", '--framer-input-border-radius-bottom-left': "4px", '--framer-input-border-radius-bottom-right': "4px", '--framer-input-border-radius-top-left': "4px", '--framer-input-border-radius-top-right': "4px", '--framer-input-border-right-width': "1px", '--framer-input-border-style': "solid", '--framer-input-border-top-width': "1px", '--framer-input-icon-color': "rgb(255, 255, 255)" } as React.CSSProperties} />
